  ...
  <div id="AboutMeSection" class="about-me-wrapper">
    ...
    <div class="about-me-summary">
      <p>
        ...
        passion for turning complex data into interfaces that fell effortless to
        use. Outside of frontend work, I've been expanding into cloud
        architecture and infrastructure, earning three AWS certifications along
        the way.
      </p>
    </div>
  </div>
